...
btn7=Button(Below, padx=16, pady=1, bd=4, fg="blue", font=("arial", 16, "bold"), width=2, height=2,
            text="7", command = lambda:btnClick(7)).grid(row=0, column=0)
btn8=Button(Below, padx=16, pady=1, bd=4, fg="blue", font=("arial", 16, "bold"), width=2, height=2,
            text="8", command = lambda:btnClick(8)).grid(row=0, column=1)
btn9=Button(Below, padx=16, pady=1, bd=4, fg="blue", font=("arial", 16, "bold"), width=2, height=2,
            text="9", command = lambda:btnClick(9)).grid(row=0, column=2)
btnSeš=Button(Below, padx=16, pady=1, bd=4, fg="blue", font=("arial", 16, "bold"), width=2, height=2,
...
btn6=Button(Below, padx=16, pady=1, bd=4, fg="blue", font=("arial", 16, "bold"), width=2, height=2,
            text="6", command = lambda:btnClick()).grid(row=1, column=2)
